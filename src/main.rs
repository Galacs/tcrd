...
async fn main() -> Result<(), Error> {
    ...
    let framework = poise::Framework::builder()
        .options(poise::FrameworkOptions {
            commands: vec![commands::manage::manage(), commands::cards::cards(), commands::balances::hourly(), commands::balances::balance(), commands::balances::daily(), commands::packs::pack(), commands::fight::fight(), commands::profile::profile(), commands::leaderboard::leaderboards(), commands::trade::trade(), commands::help::help(), commands::manage::list()],
            ..Default::default()
        })
